...
import com.example.ruleset.core.util.isComposable
import com.example.ruleset.core.util.startOffsetFromName
...
abstract class KtlintRule(
    ...
    private val config: KtlintComposeKtConfig by lazy {
        KtlintComposeKtConfig(properties, usesEditorConfigProperties)
    }
